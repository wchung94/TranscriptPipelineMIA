...
def run_cuffdiff(gtf_file, sam_file_list):
    ...
    {}, {} , {} \
    {}, {} , {} \
    ".format('cuffdiff_output_directory_CR', gtf_file,\
    sam_file_list[0], sam_file_list[7], sam_file_list[1], sam_file_list[2], sam_file_list[5], sam_file_list[3], sam_file_list[4], sam_file_list[6])
